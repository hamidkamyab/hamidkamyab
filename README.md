...
[![My Skills](https://skillicons.dev/icons?i=windows,linux,ubuntu,php,nodejs,nestjs,mysql,mongodb,html,css,js,jquery,bootstrap,tailwind,react,vue,nextjs,nuxtjs,alpinejs,pinia,npm,xd,docker,git,gitlab,github,vscode&perline=9)](https://skillicons.dev)
