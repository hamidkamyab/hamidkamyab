...
[![My Skills](https://skillicons.dev/icons?i=windows,linux,php,nodejs,nestjs,mysql,postgres,mongodb,html,css,js,ts,jquery,bootstrap,tailwind,react,vue,nextjs,nuxtjs,alpinejs,vite,postman,pinia,npm,xd,docker,git,gitlab,github,vscode&perline=10)](https://skillicons.dev)
